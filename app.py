...
with st.sidebar:
    ...
    default_idx = 0
    if saved_page in menu_options: default_idx = menu_options.index(saved_page)
    
    choice = st.radio("MENU", menu_options, index=default_idx, key="nav")
